 ...
 * required. Auth is the `x-hatchabot-owner` header the test principal reads.
 */
...
process.env.HATCHABOT_READY_POLL_MS ??= '1';
process.env.HATCHABOT_READY_TIMEOUT_MS ??= '2000';
...
export const as = (owner: string = OWNER) => ({ 'x-hatchabot-owner': owner });
