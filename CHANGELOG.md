...
### Changed
- The top bar is plain again: the page's own background, no gold wash or shadow.
...
### Changed
- The Hatchabot panel no longer says "Ask it anything" under a healthy manager; the caption appears only when something needs you (paused, failed, stopped, setting up).
...
### Changed
- The New tile's outline matches the other tiles' (soft, one pixel), and its plus is drawn, so it sits dead centre.
...
### Changed
- The New tile is a single big plus with nothing around it.
...
### Changed
- The New tile is an egg with a small plus badge at its foot.

## [2.47.4] — 2026-09-23

### Changed
- The Status tile shows an instrument panel (🎛️) instead of a heartbeat.

## [2.47.3] — 2026-09-23

### Fixed
- The New tile still had a grey surface under it (a v2-wide button rule); gone. The New tile sits at the far right of the row.
...
### Changed
- The fleet's actions in the Hatchabot panel are icon tiles — plus, inbox, chart, flag, gear, each with a caption — in the same row as the fleet's numbers, instead of a row of buttons stacked above them.
